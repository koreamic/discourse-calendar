...
describe PostsController do
  ...
  describe "schedule" do
    ...
    it "works" do
      xhr :post, :create, { title: title, raw: "[schedule title='Test Driven Development Conference' start_date_time=2017-01-02 end_date_time=2017-01-05 all_day=true]\n- Location : LA\n- Contents\n 1. TEST1\n 2. TEST2\n[/schedule]" }
    ...
    it "should have start date time" do
      xhr :post, :create, { title: title, raw: "[schedule title='Test Driven Development Conference' end_date_time=2017-01-05 all_day=true]\n- Location : LA\n- Contents\n 1. TEST1\n 2. TEST2\n[/schedule]" }
    ...
    it "should precede start date time before end date time" do
      xhr :post, :create, { title: title, raw: "[schedule title='Test Driven Development Conference' start_date_time=2017-10-01 end_date_time=2017-01-05 all_day=true]\n- Location : LA\n- Contents\n 1. TEST1\n 2. TEST2\n[/schedule]" }
      expect(response).not_to be_success
      json = ::JSON.parse(response.body)
  ...
  describe "multiple schedules" do
    it "work" do
      xhr :post, :create, { title: title, raw: "[schedule title='Test Driven Development Conference' start_date_time=2017-01-01T10:00 end_date_time=2017-01-01T11:00 all_day=false]\n- Location : LA\n- Contents\n 1. TEST1\n 2. TEST2\n[/schedule]\n[schedule title='Test Driven Development Conference' start_date_time=2017-01-01T14:00 end_date_time=2017-10-01T15:00 all_day=false]\n- Location : LA\n- Contents\n 1. TEST1\n 2. TEST2\n[/schedule]" }
      expect(response).to be_success
